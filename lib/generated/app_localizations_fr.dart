...
class AppLocalizationsFr extends AppLocalizations {
  ...
  String get welcomeMessage =>
      '🎉 Bienvenue dans Triplex 🎉\n\nDans ce jeu, vous avez un temps limité pour trouver des triplets de tuiles correspondantes basées sur leurs attributs.\nChaque tuile a différents attributs (ex: représentation, taille, couleur, fond).\n\nSélectionnez trois tuiles pour former une correspondance.\n\nVous avez une correspondance valide si, pour chaque attribut, les trois tuiles sont soit toutes identiques soit toutes différentes.\nLe but est de trouver autant de correspondances valides que possible avant la fin du temps!\n\nBonne chance et amusez-vous bien! 🍀';
