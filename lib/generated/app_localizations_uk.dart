...
class AppLocalizationsUk extends AppLocalizations {
  ...
  String get tutorial_good_desc =>
      'Однакова одиночна іконка синього серця присутня на всіх плитках. Кольори фону різні між плитками.';
  ...
  String get tutorial_wrong_desc =>
      'Іконка представлення середньої плитки (корона) така сама, як у лівої плитки, але відрізняється від правої (прапор). Іконки представлення плиток повинні бути або всі однаковими, або всі різними.';
